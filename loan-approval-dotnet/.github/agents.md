# AGENTS.md — loan-approval-dotnet  (Context file)

## Service Overview
ASP.NET Core .NET 10 Minimal API for retail banking loan approvals.
...
## Architecture Rules
- Minimal API endpoints in separte controller.cs — thin, delegate immediately to services.
...
- Nullable reference types enabled (default in .NET 10). All types must be nullable-aware.
